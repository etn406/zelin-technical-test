...
@Component({
  selector: 'app-deleted-books-page',
  imports: [BooksTableComponent, MatCardModule],
  templateUrl: './deleted-books-page.component.html',
  styleUrl: './deleted-books-page.component.scss',
})
export class DeletedBooksPageComponent {
